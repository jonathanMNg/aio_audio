...
class ApbFullPlayerPlayPause extends StatelessWidget {
  const ApbFullPlayerPlayPause({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ApbActiveStreamBuilder(
      ...
      playingBuilder: (context, psStream, playingAudio) {
        final child = ApbActiveStreamBuilder(
          loadingBuilder: (context, psStream, audio) {
            return loadingWidget;
          },
          defaultBuilder: (context) {
            return playWidget;
          },
          playingBuilder: (context, psStream, audio) {
            return ApbCustomStreamBuilder<PlayerState>(
