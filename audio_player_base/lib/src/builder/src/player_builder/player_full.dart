                        ...
                        child: SizedBox(
                          ...
                          child: Row(
                            children: [
                              IconButton(
                                onPressed: () {
                                  controller.animateTo(playerMinHeightPercentage,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ApbPrevWidget(),
                                            if(config.enableSkipForwardBackwardButton) ApbSkipBackwardWidget(),
                                            ApbPlayPauseWidget(
                                            ...
                                            if(config.enableSkipForwardBackwardButton) ApbSkipForwardWidget(),
                                            ApbNextWidget(),
                                          ],
                                        ),
                                        SizedBox(height: 15),
                                        Row(
                                          mainAxisAlignment:
                                              MainAxisAlignment.spaceBetween,
                                          children: [
                                            if(config.enableSpeedButton) ApbSpeedToggleWidget(),
                                            if(config.enableTimerButton) ApbTimerWidget(config: config.timerConfig,),
                                            if(config.enableLoopButton) ApbLoopToggleWidget(),
                                            if(config.enableShuffleButton) ApbShuffleToggleWidget(),
                                          ],
                                        ),
                                      ],
                                    ),
